<template>
  <g :transform="transform">
    ...
    <circle cx="123.5" cy="28" r="26" :stroke="color" stroke-width="4"></circle>
    <circle cx="56.5" cy="37" r="26" :stroke="color" stroke-width="4"></circle>
    <path
      ...
      stroke-width="4"
    ></path>
    <path d="M31 39L1 44.5" :stroke="color" stroke-width="4"></path>
  </g>
</template>
